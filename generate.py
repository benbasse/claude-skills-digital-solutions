...
add("mobile-developer", "dev", "mobile-developer", "Mobile Developer",
    "Skills of a mobile developer (React Native/Flutter or native) for field applications — delivery drivers, sales reps, field agents on the move. Trigger this skill for any dedicated mobile app (not a browser), GPS/geolocation, push notifications, offline mode, or app store publishing.",
...
add("ml-ai-engineer", "dev", "ml-ai-engineer", "ML / AI Engineer",
    "Skills of an ML/AI engineer for predictive use cases (risk scoring, delivery time estimation, fraud detection) applied to a real product. Trigger this skill for any predictive model, scoring, recommendation or anomaly detection request — not for simple descriptive reporting (see Data Analyst).",
...
add("ux-researcher", "design-product", "ux-researcher", "UX Researcher",
    "Skills of a UX Researcher for understanding real user needs (merchants, field workers, end customers) through qualitative and quantitative methods. Trigger this skill for user interview guides, usability testing, or behavioral analysis.",
...
add("seo-specialist", "marketing", "seo-specialist", "SEO Specialist",
    "SEO skills for improving the organic visibility of the platform and any customer-facing storefronts, with attention to local/regional SEO where relevant. Trigger this skill for SEO optimization, keyword research, or technical SEO audits.",
...
add("social-media-manager", "marketing", "social-media-manager", "Social Media / Community Manager",
    "Social media and community management skills for building awareness and trust with merchants and customers on the platforms popular in your market. Trigger this skill for content calendars, social media strategy, or online community management.",
...
add("data-scientist", "data", "data-scientist", "Data Scientist",
    "Skills of a Data Scientist for advanced statistical analysis and exploratory modeling, complementing the ML/AI Engineer, who focuses on productionizing models. Trigger this skill for deep statistical analysis, customer/merchant segmentation, or exploring patterns in data.",
